  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-20 lg:px-8">
        ...
        <div className="mt-8 max-w-2xl space-y-4 sm:mt-14">
          <h1 className="text-4xl font-semibold tracking-tight sm:text-5xl lg:text-6xl">Partes de trabajo</h1>
        ...
        <div className="mt-10 grid gap-3 sm:mt-16 sm:grid-cols-3 sm:gap-4">
          {pasos.map((paso) => {
            ...
            return (
              <div key={paso.title} className="rounded-[1.25rem] border border-slate-200 bg-white/95 p-4 shadow-soft dark:border-slate-800 dark:bg-slate-900/85 sm:rounded-[1.75rem] sm:p-6">
