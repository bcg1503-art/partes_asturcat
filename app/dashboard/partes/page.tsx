...
export default async function PartesPage({ searchParams }: PartesPageProps) {
  ...
  return (
    <section className="rounded-[1.25rem] border border-slate-200 bg-white/95 p-4 shadow-soft dark:border-slate-800 dark:bg-slate-900/90 sm:rounded-[1.75rem] sm:p-6">
