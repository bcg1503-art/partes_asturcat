...
export function Sidebar({ horasSemana = 0, isAdmin = false }: SidebarProps) {
  ...
  return (
    <aside className="hidden min-h-[calc(100vh-4rem)] w-full max-w-[18rem] flex-none rounded-[1.75rem] border border-slate-200 bg-white/95 p-6 shadow-soft dark:border-slate-800 dark:bg-slate-950/90 lg:block">
      <div className="mb-8">
